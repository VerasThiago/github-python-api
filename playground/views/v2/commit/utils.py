...
from playground.serializers.repo import RepoSerializer
from playground.serializers.commit import CommitSerializer
from django.http import JsonResponse
from testproject.celery import app
from playground.utils.cache_type import RepoCacheType
...
def get_commits(request):
    ...
    repo_cache_type, repo = repo_cache_status(Repo(owner=owner, name=repo_name))
